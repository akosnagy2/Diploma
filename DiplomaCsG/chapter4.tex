...
\begin{figure}[H]
\centering
\includegraphics[height=75mm, keepaspectratio]{figures/real_robot_velocity.pdf}
\caption{Valós robot pályakövetése különbözõ sebességeken.} 
\label{fig:realRobotVelocity}
\end{figure}
