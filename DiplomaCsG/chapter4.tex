...
Az orientáció szabályozás esetén az elõírt pólusok értékein kívül a szenzorsor pozíciójával is lehetõségünk van módosítani a szabályozás minõségét. Intuitívan beláthatjuk, hogy minél elõrébb tekintünk, annál gyorsabban tudunk reagálni, így alacsonyabb beavatkozójel szükséges a szabályozás során. Ezt a következõképpen írhatjuk le \cite{RobonAUTszem}:
