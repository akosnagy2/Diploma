...
\usepackage{etoolbox}
\usepackage{dirtree}
\usepackage[bottom]{footmisc} %footnote az oldal aljára kényszerítése
\usepackage[defaultlines=2,all]{nowidow} %fattyúsorok
\usepackage{algorithm} %algoritmus
\usepackage{algpseudocode}

\apptocmd{\thebibliography}{\raggedright}{}{}% URL túllógás


%--------------------------------------------------------------------------------------
% Main variables
%--------------------------------------------------------------------------------------
\newcommand{\vikszerzo}{Csorvási Gábor}
\newcommand{\vikkonzulens}{Kiss Domokos}
\newcommand{\vikcim}{Pályatervezési és pályakövetõ szabályozási algoritmusok fejlesztése robotautóhoz}
\newcommand{\viktanszek}{Automatizálási és Alkalmazott Informatikai Tanszék}
\newcommand{\vikdoktipus}{Diplomaterv}
\newcommand{\vikdepartmentr}{Csorvási Gábor}
