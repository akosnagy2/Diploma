...
\par
A keresett robotsebesség érdekében, fejezzük ki \aref{eq:backacp}. egyenletet ${v_w}^{e}(k)$-re. Ekkor egy negyedfokú egyenletet kapunk, ami a következõképpen épül fel:
...
Tehát \aref{eq:backacp10} feltétel alapján \aref{eq:backacp9}. egyenlõtlenség elsõ két tagja biztosan nem negatív, és mivel az egyenlõtlenség többi tagja is biztosan nem negatív, így biztosak lehetünk benne, hogy \aref{eq:backacp3}. egyenletnek lesz valós megoldása.
