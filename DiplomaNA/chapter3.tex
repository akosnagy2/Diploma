...
\end{align}
ahol $\beta(k)$ a robot szöggyorsulása, $r(k)$ a pálya görbületi sugara a robot középpontjához viszonyítva (\aref{eq:diffRobotWheel}. egyenlet alapján következik, hogy a sebességek aránya is ugyanez lesz).
...
\par
A visszaterjesztés során a sebesség és szögsebesség korlátokkal nem kell foglalkoznunk, hiszen mindkét esetben, mikor módosítjuk a sebességet, csökkentjük az értékét, és ezáltal ezektõl a korlátoktól távolodunk.
