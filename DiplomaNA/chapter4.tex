...
%----------------------------------------------------------------------------
A pályakövetés ismertetése elõtt tekintsük át, hogy pontosan mit értünk pálya alatt, amelyet követni szeretnénk.
...
\par
Fontos kérdés, hogy a pálya mely pontját válasszuk az alapjelszámoláshoz. Mindenképp a sebességszabályozónál használt referenciapontnál távolabbi pontot keresünk, hiszen a referenciapont van a robothoz legközelebb, és nem akarjuk, hogy az orientációszabályozás a pályán visszafelé irányítsa a robotot. 
...
\caption{A túlszaladás problémája szimulátorban. A robot alakját nem mutatja az ábra, csak a határolóvonalait.} 
