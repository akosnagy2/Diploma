...
% Main variables
%--------------------------------------------------------------------------------------
\newcommand{\vikszerzo}{Nagy Ákos}
\newcommand{\vikkonzulens}{Kiss Domokos}
\newcommand{\vikcim}{Pályatervezési és pályakövetõ szabályozási algoritmusok fejlesztése differenciális robothoz}
...
\singlespacing
\frenchspacing
\hyphenation{IterateTree GetGuidePoint GetALC TurnAndExtend}
