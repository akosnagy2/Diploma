...
\begin{figure}[H]
\centering
\includegraphics[width=130mm, keepaspectratio]{figures/reeds_shepp.png}
\caption{Két lehetséges Reeds-Shepp megoldástípus\cite{ReedsShepp}} 
...
\caption{Érintõ körök, szaggatottal a második megoldás} 
\label{fig:erintoKor}
\end{figure}
...
\par
Az esetek nagy többségében a celladekompozíciós eljárással tervezett globális pálya, jó eredménnyel szolgál, de néhány speciális esetben lehetséges, hogy olyan pályával tér vissza, melyet egy autóval képtelenség megoldani. Ilyen eset például két, egymásra merõleges, autó szélességû folyosó, ahol az elfordulásra nincs hely, de ezt a globális tervezõ nem veszi észre. Egy másik problémás eset a párhuzamos parkolás, amely ugyan végrehajtható lenne, de a tervezés során kialakult konfigurációk ezt majdnem lehetetlenné teszik. \footnote{Természetesen a $c\overline{c}S$ segítségével található megoldás, de ez csak elméleti megoldás, a valóságban használhatatlan megoldáshoz vezet.} A következõ fejezetben bemutatunk egy másik globális tervezõt, mely ezeket a problémákat megoldja.
