...
\caption{Szimuláció mûködés közben. Jobb középen oldalt a sebesség és gyorsulás profil, alatta a kormányszög értéke.} 
...
\begin{figure}[H]
\centering
\includegraphics[height=50mm, keepaspectratio]{figures/frame3vrep.png}
\caption{A RTR és C*CS algoritmusok együttes mûködése} 
...
\par
Elkészült a hardvere egy robotautónak, melynek elsõdleges célja az ilyen pályatervezési és pályakövetési algoritmusok kipróbálása. A fejlesztés a dolgozat írásának idejében is zajlik, remélhetõleg minél hamarabb kipróbálhatjuk valós környezetben is. A robot fel lett készítve különbözõ szenzoradatok fogadására, ez teszi lehetõvé, hogy a következõ RobonAUT \cite{RobonAUT} versenyen a Safety Car-ként üzemeljen.
