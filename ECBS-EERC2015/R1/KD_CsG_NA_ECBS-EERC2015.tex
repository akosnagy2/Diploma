...
\begin{figure}[tb]
    ...
    \centerline{
    \subfloat[]{\includegraphics[height=0.55\columnwidth]{.//figures/DynamicSim/Local/plannedPath91C.pdf}
    \label{subfig:dynamicSim_Local_Good1}}
    }
    \centerline{    
    \subfloat[]{\includegraphics[height=0.55\columnwidth]{.//figures/DynamicSim/Local/plannedPath91N.pdf}
