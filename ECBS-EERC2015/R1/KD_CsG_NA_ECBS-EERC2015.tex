...
\begin{figure}[tb]
    ...
    \label{subfig:phase1}}}
    \centerline{
    \subfloat[]{\includegraphics[height=0.35\columnwidth]{.//figures/DynamicSim/plannedPath11N.pdf}
    \label{subfig:phase2}}}
    \centerline{
    \subfloat[]{\includegraphics[height=0.35\columnwidth]{.//figures/DynamicSim/plannedPath43N.pdf}
    \label{subfig:phase3}}}    
    \centerline{
