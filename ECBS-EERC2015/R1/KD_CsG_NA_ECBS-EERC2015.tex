...
\begin{figure}[tb]
    \centerline{
    \subfloat[]{\includegraphics[height=0.35\columnwidth]{.//figures/StaticSim/frame130.pdf}
    \label{subfig:frame130}}}
    \centerline{
    \subfloat[]{\includegraphics[height=0.35\columnwidth]{.//figures/StaticSim/frame146.pdf}
    \label{subfig:frame146}}}
    \centerline{
    \subfloat[]{\includegraphics[height=0.35\columnwidth]{.//figures/StaticSim/frame153.pdf}
    \label{subfig:frame153}}}    
    \centerline{
    \subfloat[]{\includegraphics[height=0.35\columnwidth]{.//figures/StaticSim/frame173.pdf}
